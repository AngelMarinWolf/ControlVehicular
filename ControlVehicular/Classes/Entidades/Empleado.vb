Public Class Empleado
    ...
    Public Function RegistrarEmpleado() As Boolean
        ...
        Dim valores As String() = {"'" & Me.curp & "'", "'" & Me.rfc & "'", "'" & Me.nombre & "'", "'" & Me.paterno & "'", "'" & Me.materno & "'", "'" & Me.username & "'",
                                   "'" & Me.password & "'", Me.edad, "'" & Me.sexo & "'", "'" & Me.telefono & "'", "'" & Me.email & "'", "'" & Me.idDomicilio & "'"}
    ...
    Public Function ActualizarEmpleado() As Boolean
        ...
        Dim valores As String() = {"'" & Me.rfc & "'", "'" & Me.nombre & "'", "'" & Me.paterno & "'", "'" & Me.materno & "'", "'" & Me.username & "'",
                                   "'" & Me.password & "'", Me.edad, "'" & Me.sexo & "'", "'" & Me.telefono & "'", "'" & Me.email & "'", "'" & Me.idDomicilio & "'"}
    ...
    Public Function BuscarEmpleadoById(curp As String) As Boolean
        Dim database As Oracle = New Oracle()
        Dim columnas As String() = {"curp", "rfc", "nombre", "paterno", "materno", "username", "password", "edad", "sexo", "telefono", "email", "idDomicilio"}
